...
namespace OneDc.Infrastructure.Migrations
{
    ...
    [Migration("20251121111846_AddSoftDeleteToProjects")]
    partial class AddSoftDeleteToProjects
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("OneDc.Domain.Entities.AppUser", b =>
                {
                    ...
                    b.HasIndex("EmployeeId")
                        .IsUnique()
                        .HasDatabaseName("ix_app_user_employee_id");
            ...
            modelBuilder.Entity("OneDc.Domain.Entities.Project", b =>
                {
                    ...
                    b.HasIndex("IsDeleted")
                        .HasDatabaseName("ix_project_is_deleted");
