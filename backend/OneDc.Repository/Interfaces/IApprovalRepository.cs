...
public interface IApprovalRepository
{
    ...
    Task<IEnumerable<TimesheetEntry>> GetAllPendingAsync(DateOnly from, DateOnly to, Guid? projectId = null, Guid? userId = null);
    Task<TimesheetEntry?> GetByIdAsync(Guid entryId);
    Task SaveChangesAsync();
    Task<AppUser?> GetApproverAsync(Guid approverId);
